...
// el initial state y la funcion init TAMBIEN se van al archivo de reducers en este estilo de encarpetado mejorado y desaparecen de aqui
...
//ESTE SE VA PARA EL ARCHIVO CONTADORACTIONS.JS
// const TYPES = {
//     INCREMENT: 'INCREMENT',
...
//esta desaparecede aqui y se lleva a contador reducer
...
const ContadorReducerMejorado = () => {
    ...
    return ( 
        <div style={{textAlign:'center'}}>
            <h2>Contador con useReducer MEJORADO on Steroids</h2>
            <nav>        
